/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce2d7f4924a3c4ffa1df21e76098e8a4)
// Runtime types generated with workerd@1.20250422.0 2025-03-27 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		YOUTUBE_API_KEY: string;
		KudosAgent: DurableObjectNamespace<import("./src/index").KudosAgent>;
		SCREENSHOTS: R2Bucket;
		AI: Ai;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		YOUTUBE_GATHERER: Workflow;
		SCREENSHOT_PARSER: Workflow;
	}
}
